...
class NewsEntertainmentCategory extends StatelessWidget {
  //variabel bertipe RequestSportCategory di mana isinya terdapat apikey berdasrakan kategori sport
  RequestEntertainmentCategory requestScienceCategory =
      RequestEntertainmentCategory();
  String newsEntertainment;

  NewsEntertainmentCategory(
      {super.key, required this.newsEntertainment}); //konstruktor
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
          future: requestScienceCategory.getNewsByCategory(newsEntertainment),
          builder: (context, snapshot) {
            //snapshot mendapatkan data maka return ke ListSportNewsCategory
            if (snapshot.hasData) {
              return ListEntertainmentNewsCategory(snapshot.data);
            }
...
// ignore: must_be_immutable
class ListEntertainmentNewsCategory extends StatelessWidget {
  NewsRespon? responseBerita;

  ListEntertainmentNewsCategory(this.responseBerita, {super.key}); //konstruktor
