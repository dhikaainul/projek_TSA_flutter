...
class NewsScienceCategory extends StatelessWidget {
  //variabel bertipe RequestSportCategory di mana isinya terdapat apikey berdasrakan kategori sport
  RequestScienceCategory requestScienceCategory = RequestScienceCategory();
  String newsScience;

  NewsScienceCategory({super.key, required this.newsScience}); //konstruktor
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
          future: requestScienceCategory.getNewsByCategory(newsScience),
          builder: (context, snapshot) {
            //snapshot mendapatkan data maka return ke ListSportNewsCategory
            if (snapshot.hasData) {
              return ListScienceNewsCategory(snapshot.data);
            }
...
// ignore: must_be_immutable
class ListScienceNewsCategory extends StatelessWidget {
  NewsRespon? responseBerita;

  ListScienceNewsCategory(this.responseBerita, {super.key}); //konstruktor
